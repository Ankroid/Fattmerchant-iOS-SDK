...
public struct Amount {
  ...
  /// Initializes the Amount with the given cents amount. This initializer is preferred.
  ///
  /// - Parameter cents: the amount in cents
  ///
  /// ### Example
  /// ```
  /// let amount = Amount(cents: 498)
  /// amount.cents // => 498
  /// amount.dollars() // => 4.98
  /// ```
  ...
  /// A double representation of the dollar amount with two significant figures.
  ///
  /// ### Example
  /// ```
  /// let amount = Amount(dollars: 5.99378)
